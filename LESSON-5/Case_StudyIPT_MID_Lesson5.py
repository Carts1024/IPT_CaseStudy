...
def Item_2():
    os.system('cls')
    print('----------------------------------------------------------------------------------------------------------------------------')
    print('                      WRITE A PROGRAM THAT WILL ASK USER TO INPUT A LIST OF INTEGER TUPLES.\n                      ASK ALSO FOR ANOTHER INTEGER VALUE AND ASSIGN IT TO K.\n                      OUTPUT THE TUPLE THATARE DIVISIBLE BY K.')
    print('----------------------------------------------------------------------------------------------------------------------------\n')
